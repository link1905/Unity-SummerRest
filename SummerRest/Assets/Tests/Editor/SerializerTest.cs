...
namespace Tests.Editor
{
    ...
    {
        private static readonly IDataSerializer Serializer = new DefaultDataSerializer(); 
...
".RemoveEscapeChar();
            ...
            var result = Serializer.Serialize(model, DataFormat.Json);
...
".RemoveEscapeChar(); 
            var model = new TestModel("5", 5, 5.5f);
            var result = Serializer.Serialize(model, DataFormat.Xml);
        ...
        public void Test_Serialize_To_Plain_Return_Null()
        {
            ...
            var result = Serializer.Serialize(model, DataFormat.PlainText);
        ...
        public void Test_Serialize_From_Null_Return_Null()
        {
            var result = Serializer
                .Serialize<string>(null, DataFormat.Json);
            Assert.IsNull(result);
        }
        [Test]
        public void Test_Serialize_String_Then_Return_The_String_Itself()
        {
            ...
            result = Serializer.Serialize(model, DataFormat.Xml);
            Assert.AreSame(model, result);
            result = Serializer.Serialize(model, DataFormat.PlainText);
            Assert.AreSame(model, result);
        }
        [Test]
...
";
            var model = new TestModel("5", 5, 5.5f);
            var result = Serializer.Deserialize<TestModel>(json, DataFormat.Json);
...
";
            ...
            var result = Serializer.Deserialize<TestModel>(xml, DataFormat.Xml);
            Assert.That(model.Equals(result));
        }
        ...
        public void Test_Deserialize_To_Plain_Model_Then_Returns_Null()
        {
            ...
            var result = Serializer.Deserialize<TestModel>(json, DataFormat.PlainText);
            Assert.IsNull(result);
            LogAssert.Expect(LogType.Error,
        ...
        {
            const string json = "my json";
            var result = Serializer.Deserialize<string>(json, DataFormat.PlainText);
